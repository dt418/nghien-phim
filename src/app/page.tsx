      ...
      <section className="grid grid-cols-12 gap-x-6 gap-y-4">
        <div className="flex flex-col sm:col-span-9 col-span-12 gap-2">
          <div className="flex gap-3 pb-2">
            <h2 className="text-[14px] font-medium cursor-pointer transition-all ease-linear duration-100 rounded-sm px-3 py-1 uppercase block bg-[#A3765D]">
              PHIM BỘ MỚI
            </h2>
          </div>
              ...
              <div className="w-full">
                ...
                <ul className="flex list-none mb-2 pt-2 flex-wrap flex-row">
                  ...
                  <li className="-mb-px mr-2 cursor-pointer last:mr-0 flex-auto text-center">
                    <div className="text-[14px] font-medium px-3 py-1 block">
                      Ngày
                    </div>
                  </li>
                  <li className="-mb-px mr-2 cursor-pointer last:mr-0 flex-auto text-center">
                        ...
                        >
                          <div className="col-span-2">
                            <div className="font-medium text-md hover:shadow-lg">
                              <span className="leading-7 text-xs bg-[#c58560] w-7 h-7 inline-block rounded-full text-center">
                                1
                              </span>
                            </div>
                          </div>
